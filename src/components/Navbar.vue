<template>
    <div id="menuBar">
      <ul class="text-center">
        <li>
          <a href="#">Your TDB Account</a>
        </li>
        <li>
          <a href="#">Lorem ipsum dolor sit amet</a>
        </li>
        <li>
          <a href="#">Our AI System</a>
        </li>
        <li>
    ...
    <nav class="navbar navbar-light">
      <div class="row" style="flex-grow:1;text-align:center">
        <div class="col">
          <!-- Collapse button -->
          <button id="menuBarButton" class="btn" @click="toggleNav()">
            <i class="fa fa-bars fa-2x"></i> 
          </button>
        </div>
        <div class="col">
          <router-link to="/"><h3 id="pageTitle">TBD</h3></router-link>
        </div>
        <div class="col">
          <div class="row">
...
export default {
    ...
    methods: {
        toggleNav() {
            let menuBox = document.querySelector('#menuBar')
            menuBox.style.display === "none" ? menuBox.style.display = "block" : menuBox.style.display = "none"
        }
    }
}
